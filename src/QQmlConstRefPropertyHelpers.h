/**
 * \file QQmlConstRefPropertyHelpers.h
 * \brief Declare CstRef Properties Helper 
 */
...
/**
 * \defgroup QSM_CSTREF_HELPER ConstRef Properties
 * \brief Macros to generate ConstRef Property that use `T`. `const type &` will be added where required.
 */
 ...
 *      const type & GetName(void) const { return _name; }
 *
 *      // Qt Naming Convention
 *      const type & name(void) const { return m_name; }
 *  \endcode
 */
#define QSM_CSTREF_GETTER(type, name, Name) \
 ...
 *  \endcode
 */
#define QSM_CSTREF_SETTER(type, name, Name) \
 ...
 * To have a Qt-ish Signal (ie `<name>Changed(const type & <name>)`), define `QSUPERMACROS_USE_QT_SIGNALS` in your build system
 * \ingroup QSM_CSTREF_HELPER
 * \hideinitializer
 * \param type Type of the attribute (`int`, `quint32`, `QString`, etc...)
 * \param name Attribute name in lowerCamelCase
 ...
 *  \endcode
 */
#define QSM_CSTREF_NOTIFIER(type, name, Name) \
 ...
 *  \endcode
 */
#define QSM_CSTREF_MEMBER(type, name, Name, def) \
 ...
 *  \endcode
 */
#define QSM_CSTREF_RESET(type, name, Name, def) \
    bool QSM_MAKE_RESET_NAME(name, Name)() { return QSM_MAKE_SETTER_NAME(name, Name)(def); }

/** Generate a **Writable** Const Ref Property
 ...
 *  QSM_WRITABLE_CSTREF_PROPERTY_WDEFAULT(int, myInt, MyInt, 23);
 * 
 *  // Create a QString with default value "MyString"
 *  QSM_WRITABLE_CSTREF_PROPERTY_WDEFAULT(QString, myString, MyString, "MyString");
 * 
 *  // Create a bool with default value false
 *  QSM_WRITABLE_CSTREF_PROPERTY_WDEFAULT(bool, myBool, MyBool, false);
 *  \endcode 
 */
#define QSM_WRITABLE_CSTREF_PROPERTY_WDEFAULT(type, name, Name, def) \
    protected: \
    ...
    private: \
        QSM_CSTREF_MEMBER (type, name, Name, def) \
    public: \
        QSM_CSTREF_GETTER (type, name, Name) \
        QSM_CSTREF_SETTER (type, name, Name) \
        QSM_CSTREF_RESET (type, name, Name, def) \
    Q_SIGNALS: \
        QSM_CSTREF_NOTIFIER (type, name, Name) \
    private:
 ...
 *  QSM_WRITABLE_CSTREF_PROPERTY(int, myInt, MyInt);
 * 
 *  // Create a QString with default value {}
 *  QSM_WRITABLE_CSTREF_PROPERTY(QString, myString, MyString);
 * 
 *  // Create a bool with default value {}
 *  QSM_WRITABLE_CSTREF_PROPERTY(bool, myBool, MyBool);
 *  \endcode 
 */
#define QSM_WRITABLE_CSTREF_PROPERTY(type, name, Name) \
    QSM_WRITABLE_CSTREF_PROPERTY_WDEFAULT(type, name, Name, {} )

/** Generate a **Read-Only** Const Ref Property
 * Auto Property uses either `T` or `T*` and is capable of adding constant-reference by 
 * deciding itself which type is the cheapest (using some template trickery internally).
 * \ingroup QSM_CSTREF_HELPER
 * \hideinitializer
 ...
 *  \code 
 *  // Create an integer with default value 23
 *  QSM_READONLY_CSTREF_PROPERTY(int, myInt, MyInt, 23);
 * 
 *  // Create a QString with default value "MyString"
 *  QSM_READONLY_CSTREF_PROPERTY(QString, myString, MyString, "MyString");
 * 
 *  // Create a bool with default value false
 *  QSM_READONLY_CSTREF_PROPERTY(bool, myBool, MyBool, false);
 *  \endcode 
 */
#define QSM_READONLY_CSTREF_PROPERTY_WDEFAULT(type, name, Name, def) \
    protected: \
 ...
 *  \code 
 *  // Create an integer with default value {}
 *  QSM_READONLY_CSTREF_PROPERTY(int, myInt, MyInt);
 * 
 *  // Create a QString with default value {}
 *  QSM_READONLY_CSTREF_PROPERTY(QString, myString, MyString);
 * 
 *  // Create a bool with default value {}
 *  QSM_READONLY_CSTREF_PROPERTY(bool, myBool, MyBool);
 *  \endcode 
 */
#define QSM_READONLY_CSTREF_PROPERTY(type, name, Name) \
    QSM_READONLY_CSTREF_PROPERTY_WDEFAULT(type, name, Name, {})

/** Generate a **Constant** Const Ref Property
 * Auto Property uses either `T` or `T*` and is capable of adding constant-reference by 
 * deciding itself which type is the cheapest (using some template trickery internally).
 * \ingroup QSM_CSTREF_HELPER
 * \hideinitializer
 ...
 *  \code 
 *  // Create an integer with default value 23
 *  QSM_CONSTANT_CSTREF_PROPERTY_WDEFAULT(int, myInt, MyInt, 23);
 * 
 *  // Create a QString with default value "MyString"
 *  QSM_CONSTANT_CSTREF_PROPERTY_WDEFAULT(QString, myString, MyString, "MyString");
 * 
 *  // Create a bool with default value false
 *  QSM_CONSTANT_CSTREF_PROPERTY_WDEFAULT(bool, myBool, MyBool, false);
 *  \endcode 
 */
#define QSM_CONSTANT_CSTREF_PROPERTY_WDEFAULT(type, name, Name, def) \
    protected: \
 ...
 *  \code 
 *  // Create an integer with default value {}
 *  QSM_CONSTANT_CSTREF_PROPERTY(int, myInt, MyInt);
 * 
 *  // Create a QString with default value {}
 *  QSM_CONSTANT_CSTREF_PROPERTY(QString, myString, MyString);
 * 
 *  // Create a bool with default value {}
 *  QSM_CONSTANT_CSTREF_PROPERTY(bool, myBool, MyBool);
 *  \endcode 
 */
#define QSM_CONSTANT_CSTREF_PROPERTY(type, name, Name) \
        QSM_CONSTANT_CSTREF_PROPERTY_WDEFAULT(type, name, Name, {})

/**
 * \internal
 */
class QSUPERMACROS_API_ _Test_QmlCstRefProperty_ : public QObject 
{
    Q_OBJECT

    QSM_WRITABLE_CSTREF_PROPERTY (int,     var1, Var1)
    QSM_READONLY_CSTREF_PROPERTY (bool,    var2, Var2)
    QSM_CONSTANT_CSTREF_PROPERTY (QString, var3, Var3)

    QSM_WRITABLE_CSTREF_PROPERTY_WDEFAULT (int,     var4, Var4, 1)
    QSM_READONLY_CSTREF_PROPERTY_WDEFAULT (bool,    var5, Var5, false)
    QSM_CONSTANT_CSTREF_PROPERTY_WDEFAULT (QString, var6, Var6, "MyString")
};
